...
public abstract class Conta implements iConta {
    ...
    public void simulacaoDeRendimento(double saldo) {
        ...
        int count = 0;
        int meses;
        double taxaDeJuros = 0.0063;
        double montante = saldo;
        System.out.println("Quantos meses quer que a simulação seja realizada?");
        meses = sc.nextInt();
        while (count < meses){
        ...
        if (meses == 1)
            System.out.printf("Em 1 mês você vai ter R$ "+"%.2f%n", montante);
        else
            System.out.printf("Em "+meses+" meses você vai ter R$ "+"%.2f%n", montante);
